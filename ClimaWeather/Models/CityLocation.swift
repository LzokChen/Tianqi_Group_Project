...
//    var groupTitles = [String]()
    ...
    func search(_ searchContent:String){
        searchCitys.removeAll()
        for city in CityNames {
            if(city.contains(searchContent)){
                searchCitys.append(city)
            }
        }
    }
}
